...
def policy_instrument_input(self, len_PC):
	...
	policy_instruments[0] = [None, -5, None, None, None]  # PI1.1 - Vi,Mo,LMo,T0P,T1P
	policy_instruments[1] = [None, +5, None, None, None]  # PI1.2 - Vi,Mo,LMo,T0P,T1P
	...
	policy_instruments[4] = [None, None, None,-5, None]  # PI2.1 - Vi,Mo,LMo,T0P,T1P
	policy_instruments[5] = [None, None, None, +5, None]  # PI2.2 - Vi,Mo,LMo,T0P,T1P
	policy_instruments[6] = [None, None, None, None, -5]  # PI2.3 - Vi,Mo,LMo,T0P,T1P
	policy_instruments[7] = [None, None, None, None, +5]  # PI2.4 - Vi,Mo,LMo,T0P,T1P
...
def issue_mapping(S_issues, PC_issues, DC_issues, type0agents, type1agents):

	'''
	This function takes the KPIs and transforms them onto an interval of -1 to 1 for the agent beliefs and other applications within the model.
	'''
