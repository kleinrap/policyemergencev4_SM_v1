...
numberOfExperiments = 25	# How many experiments can we afford ?
...
# 1. The belief tree aims (3 profiles) - 1 of 3 for floods: 1
# 2. The affiliation weight 1 - from 0.7 to 0.8 for floods: 0.75
# 3. The affiliation weight 2 - from 0.8 to 0.9 for floods 0.75
# 4. The affiliation weight 3 - from 0.9 to 1.0 for floods 0.75
# 5. The affiliation distribution 1 - from 25 to 50 for floods 10-45
# 6. The affiliation distribution 2 - from 25 to 50 for floods equal to affiliation 2
# 7. The elecorate influence on policymakers - from 0.01 to 0.10 for floods 0.05
# 8. The resource potency parameter - from 1 to 10 for floods 5
# 9. The resource weight action - from 0.05 to 0.20 for floods 0.10
# 10. The trust decay coefficient - from 0.01-0.10 for floods 0.05
# 11. The conflict level coefficient 1 - from 0.7 to 0.8 for floods 0.75
# 12. The conflict level coefficient 2 - from 0.8 to 0.9 for floods 0.75
# 13. The conflict level coefficient 3 - from 0.9 to 1.0 for floods 0.75
# 14. The team gap in belief - from 0.6 to 1.0 for floods 0.75
# 15. The team gap in closeness of problem - fom 0.2 to 0.7 for floods 0.5
# 16. The team gap in closeness of policy - from 0.2 to 0.7 for floods 0.5
# 17. The ACF threshold - from 0.15 to 0.55 for floods 0.3
...
write.table(lhs,file="Experiments_LHS_Floods.data",sep=",",row.names = FALSE,col.names = FALSE,quote = FALSE)
